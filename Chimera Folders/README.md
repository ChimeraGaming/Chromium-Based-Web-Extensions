...
4. Select the `manifest.json` inside the extracted folder.

> ⚠️ Firefox support is temporary and may reset after browser restarts unless officially published to AMO.
